...
import com.breezefieldjaimedicalplus.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldjaimedicalplus.app.utils.FTStorageUtils
import com.breezefieldjaimedicalplus.app.utils.NotificationUtils
...
import com.breezefieldjaimedicalplus.features.addshop.model.QuestionSubmit
...
import com.breezefieldjaimedicalplus.features.addshop.presentation.*
...
import com.breezefieldjaimedicalplus.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
...
import com.breezefieldjaimedicalplus.features.nearbyshops.model.StageListResponseModel
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldjaimedicalplusApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
