package com.breezefieldjaimedicalplus.features.commondialogsinglebtn
...
import com.breezefieldjaimedicalplus.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldjaimedicalplus.app.domain.VisitRemarksEntity
...
import com.breezefieldjaimedicalplus.features.addshop.presentation.ProspectListDialog
import com.breezefieldjaimedicalplus.features.dashboard.presentation.DashboardActivity
import com.breezefieldjaimedicalplus.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldjaimedicalplus.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldjaimedicalplus/files", "recorded_audio${System.currentTimeMillis()}.mp3")
