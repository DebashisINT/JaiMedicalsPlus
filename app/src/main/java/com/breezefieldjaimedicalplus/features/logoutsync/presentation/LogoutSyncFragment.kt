package com.breezefieldjaimedicalplus.features.logoutsync.presentation
...
import com.breezefieldjaimedicalplus.app.AppDatabase
...
import com.breezefieldjaimedicalplus.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldjaimedicalplus.features.billing.api.AddBillingRepoProvider
import com.breezefieldjaimedicalplus.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldjaimedicalplus.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldjaimedicalplus.features.document.model.AddEditDocumentInputParams
import com.breezefieldjaimedicalplus.features.document.model.DocumentAttachmentModel
...
import com.breezefieldjaimedicalplus.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldjaimedicalplus.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldjaimedicalplus.features.orderhistory.model.*
...
import com.breezefieldjaimedicalplus.features.quotation.model.AddQuotInputModel
import com.breezefieldjaimedicalplus.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldjaimedicalplus.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldjaimedicalplus.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldjaimedicalplus.features.stock.api.StockRepositoryProvider
import com.breezefieldjaimedicalplus.features.stock.model.AddStockInputParamsModel
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.breezefieldjaimedicalplus.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldjaimedicalplus.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldjaimedicalplus.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldjaimedicalplus.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldjaimedicalplus.mappackage.SendBrod
import com.breezefieldjaimedicalplus.widgets.AppCustomTextView
import com.breezefieldjaimedicalplus.MonitorService
import com.breezefieldjaimedicalplus.MySingleton
import com.breezefieldjaimedicalplus.app.AlarmReceiver
...
import com.breezefieldjaimedicalplus.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldjaimedicalplus.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldjaimedicalplus.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldjaimedicalplus.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldjaimedicalplus.features.orderITC.SyncOpptProductL
import com.breezefieldjaimedicalplus.features.orderITC.SyncOrd
import com.breezefieldjaimedicalplus.features.orderITC.SyncOrdProductL
import com.breezefieldjaimedicalplus.features.performance.model.Gps_status_list
import com.breezefieldjaimedicalplus.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldjaimedicalplus.features.returnsOrder.ReturnProductList
import com.breezefieldjaimedicalplus.features.returnsOrder.ReturnRequest
import com.breezefieldjaimedicalplus.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldjaimedicalplus.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldjaimedicalplus/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjaimedicalpluslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjaimedicalpluslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjaimedicalpluslogsample/log.zip").path);
