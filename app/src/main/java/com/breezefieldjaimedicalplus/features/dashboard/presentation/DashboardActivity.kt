package com.breezefieldjaimedicalplus.features.dashboard.presentation
...
import com.breezefieldjaimedicalplus.*
import com.breezefieldjaimedicalplus.R
import com.breezefieldjaimedicalplus.app.*
import com.breezefieldjaimedicalplus.app.NewFileUtils.browseDocuments
import com.breezefieldjaimedicalplus.app.NewFileUtils.browsePDFDocuments
import com.breezefieldjaimedicalplus.app.NewFileUtils.getExtension
import com.breezefieldjaimedicalplus.app.domain.*
import com.breezefieldjaimedicalplus.app.types.DashboardType
import com.breezefieldjaimedicalplus.app.types.FragType
import com.breezefieldjaimedicalplus.app.types.TopBarConfig
import com.breezefieldjaimedicalplus.app.uiaction.DisplayAlert
import com.breezefieldjaimedicalplus.app.utils.*
import com.breezefieldjaimedicalplus.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldjaimedicalplus.features.NewQuotation.*
import com.breezefieldjaimedicalplus.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldjaimedicalplus.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldjaimedicalplus.features.SearchLocation.SearchLocationFragment
import com.breezefieldjaimedicalplus.features.SearchLocation.locationInfoModel
import com.breezefieldjaimedicalplus.features.TA.ViewAllTAListFragment
import com.breezefieldjaimedicalplus.features.achievement.AchievementFragment
import com.breezefieldjaimedicalplus.features.activities.presentation.*
import com.breezefieldjaimedicalplus.features.addAttendence.*
import com.breezefieldjaimedicalplus.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldjaimedicalplus.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldjaimedicalplus.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldjaimedicalplus.features.addAttendence.model.GetReportToResponse
import com.breezefieldjaimedicalplus.features.addAttendence.model.Leave_list_Response
import com.breezefieldjaimedicalplus.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldjaimedicalplus.features.addshop.presentation.AddShopFragment
import com.breezefieldjaimedicalplus.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldjaimedicalplus.features.addshop.presentation.ScanImageFragment
import com.breezefieldjaimedicalplus.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldjaimedicalplus.features.alarm.model.AlarmData
import com.breezefieldjaimedicalplus.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldjaimedicalplus.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldjaimedicalplus.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldjaimedicalplus.features.alarm.presetation.VisitReportFragment
import com.breezefieldjaimedicalplus.features.attendance.AttendanceFragment
import com.breezefieldjaimedicalplus.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldjaimedicalplus.features.attendance.model.AttendanceRequest
import com.breezefieldjaimedicalplus.features.attendance.model.AttendanceResponse
import com.breezefieldjaimedicalplus.features.averageshop.presentation.AverageShopFragment
import com.breezefieldjaimedicalplus.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldjaimedicalplus.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldjaimedicalplus.features.beatCustom.TeamBeatListFragment
import com.breezefieldjaimedicalplus.features.billing.presentation.AddBillingFragment
import com.breezefieldjaimedicalplus.features.billing.presentation.BillingDetailsFragment
import com.breezefieldjaimedicalplus.features.billing.presentation.BillingListFragment
import com.breezefieldjaimedicalplus.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldjaimedicalplus.features.chat.model.ChatListDataModel
import com.breezefieldjaimedicalplus.features.chat.model.ChatUserDataModel
import com.breezefieldjaimedicalplus.features.chat.model.GroupUserDataModel
import com.breezefieldjaimedicalplus.features.chat.presentation.*
import com.breezefieldjaimedicalplus.features.chatbot.presentation.ChatBotFragment
import com.breezefieldjaimedicalplus.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldjaimedicalplus.features.chatbot.presentation.ReportsFragment
import com.breezefieldjaimedicalplus.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldjaimedicalplus.features.commondialog.presentation.CommonDialog
import com.breezefieldjaimedicalplus.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldjaimedicalplus.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldjaimedicalplus.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldjaimedicalplus.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldjaimedicalplus.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldjaimedicalplus.features.contacts.ActivityDtlsFrag
import com.breezefieldjaimedicalplus.features.contacts.AddOpptFrag
import com.breezefieldjaimedicalplus.features.contacts.ContactDtls
import com.breezefieldjaimedicalplus.features.contacts.ContactGr
import com.breezefieldjaimedicalplus.features.contacts.ContactsAddFrag
import com.breezefieldjaimedicalplus.features.contacts.ContactsFrag
import com.breezefieldjaimedicalplus.features.contacts.SchedulerAddFormFrag
import com.breezefieldjaimedicalplus.features.contacts.SchedulerViewFrag
import com.breezefieldjaimedicalplus.features.contacts.TemplateAddFrag
import com.breezefieldjaimedicalplus.features.contacts.TemplateViewFrag
import com.breezefieldjaimedicalplus.features.contacts.ViewCrmOpptFrag
import com.breezefieldjaimedicalplus.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldjaimedicalplus.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldjaimedicalplus.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldjaimedicalplus.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldjaimedicalplus.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldjaimedicalplus.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldjaimedicalplus.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldjaimedicalplus.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldjaimedicalplus.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldjaimedicalplus.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldjaimedicalplus.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldjaimedicalplus.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldjaimedicalplus.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldjaimedicalplus.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldjaimedicalplus.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldjaimedicalplus.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldjaimedicalplus.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldjaimedicalplus.features.document.presentation.DocumentListFragment
import com.breezefieldjaimedicalplus.features.document.presentation.DocumentTypeListFragment
import com.breezefieldjaimedicalplus.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldjaimedicalplus.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldjaimedicalplus.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldjaimedicalplus.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldjaimedicalplus.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldjaimedicalplus.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldjaimedicalplus.features.home.presentation.HomeFragment
import com.breezefieldjaimedicalplus.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldjaimedicalplus.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldjaimedicalplus.features.know_your_state.KnowYourStateFragment
import com.breezefieldjaimedicalplus.features.lead.LeadFrag
import com.breezefieldjaimedicalplus.features.lead.ViewLeadFrag
import com.breezefieldjaimedicalplus.features.leaderboard.LeaderBoardFrag
import com.breezefieldjaimedicalplus.features.leaveapplynew.LeaveHome
import com.breezefieldjaimedicalplus.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldjaimedicalplus.features.localshops.LocalShopListFragment
import com.breezefieldjaimedicalplus.features.localshops.LocalShopListMapFragment
import com.breezefieldjaimedicalplus.features.localshops.NearByShopsMapFragment
import com.breezefieldjaimedicalplus.features.location.*
import com.breezefieldjaimedicalplus.features.location.api.LocationRepoProvider
import com.breezefieldjaimedicalplus.features.location.model.*
import com.breezefieldjaimedicalplus.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldjaimedicalplus.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldjaimedicalplus.features.login.ShopFeedbackEntity
import com.breezefieldjaimedicalplus.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldjaimedicalplus.features.login.presentation.LoginActivity
import com.breezefieldjaimedicalplus.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldjaimedicalplus.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldjaimedicalplus.features.marketAssist.MarketAssistTabFrag
import com.breezefieldjaimedicalplus.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldjaimedicalplus.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldjaimedicalplus.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldjaimedicalplus.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldjaimedicalplus.features.member.MapViewForTeamFrag
import com.breezefieldjaimedicalplus.features.member.model.TeamLocDataModel
import com.breezefieldjaimedicalplus.features.member.model.TeamShopListDataModel
import com.breezefieldjaimedicalplus.features.member.presentation.*
import com.breezefieldjaimedicalplus.features.menuBeat.MenuBeatFrag
import com.breezefieldjaimedicalplus.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldjaimedicalplus.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldjaimedicalplus.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldjaimedicalplus.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldjaimedicalplus.features.myjobs.model.CustomerDataModel
import com.breezefieldjaimedicalplus.features.myjobs.presentation.*
import com.breezefieldjaimedicalplus.features.mylearning.MyLearningFragment
import com.breezefieldjaimedicalplus.features.myorder.presentation.MyOrderListFragment
import com.breezefieldjaimedicalplus.features.myprofile.presentation.MyProfileFragment
import com.breezefieldjaimedicalplus.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldjaimedicalplus.features.nearbyshops.model.ShopData
import com.breezefieldjaimedicalplus.features.nearbyshops.model.ShopListResponse
import com.breezefieldjaimedicalplus.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldjaimedicalplus.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldjaimedicalplus.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldjaimedicalplus.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldjaimedicalplus.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldjaimedicalplus.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldjaimedicalplus.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldjaimedicalplus.features.newcollection.CollectionShopListFragment
import com.breezefieldjaimedicalplus.features.newcollection.NewCollectionListFragment
import com.breezefieldjaimedicalplus.features.newcollectionreport.*
import com.breezefieldjaimedicalplus.features.notification.NotificationFragment
import com.breezefieldjaimedicalplus.features.orderITC.CartListFrag
import com.breezefieldjaimedicalplus.features.orderITC.OrderListFrag
import com.breezefieldjaimedicalplus.features.orderITC.ProductListFrag
import com.breezefieldjaimedicalplus.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldjaimedicalplus.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldjaimedicalplus.features.orderITC.ViewOrdDtls
import com.breezefieldjaimedicalplus.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldjaimedicalplus.features.orderList.NewOrderListFragment
import com.breezefieldjaimedicalplus.features.orderList.OrderListFragment
import com.breezefieldjaimedicalplus.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldjaimedicalplus.features.orderhistory.ActivityMapFragment
import com.breezefieldjaimedicalplus.features.orderhistory.OrderhistoryFragment
import com.breezefieldjaimedicalplus.features.orderhistory.TimeLineFragment
import com.breezefieldjaimedicalplus.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldjaimedicalplus.features.orderhistory.model.FetchLocationRequest
import com.breezefieldjaimedicalplus.features.orderhistory.model.FetchLocationResponse
import com.breezefieldjaimedicalplus.features.orderhistory.model.LocationData
import com.breezefieldjaimedicalplus.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldjaimedicalplus.features.performance.GpsStatusFragment
import com.breezefieldjaimedicalplus.features.performance.PerformanceFragment
import com.breezefieldjaimedicalplus.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldjaimedicalplus.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldjaimedicalplus.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldjaimedicalplus.features.performanceAPP.PerformanceAppFragment
import com.breezefieldjaimedicalplus.features.performanceAPP.allPerformanceFrag
import com.breezefieldjaimedicalplus.features.permissionList.ViewPermissionFragment
import com.breezefieldjaimedicalplus.features.photoReg.*
import com.breezefieldjaimedicalplus.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldjaimedicalplus.features.quotation.presentation.*
import com.breezefieldjaimedicalplus.features.reimbursement.presentation.*
import com.breezefieldjaimedicalplus.features.report.presentation.*
import com.breezefieldjaimedicalplus.features.returnsOrder.*
import com.breezefieldjaimedicalplus.features.settings.presentation.SettingsFragment
import com.breezefieldjaimedicalplus.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldjaimedicalplus.features.shopdetail.presentation.*
import com.breezefieldjaimedicalplus.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldjaimedicalplus.features.stock.StockDetailsFragment
import com.breezefieldjaimedicalplus.features.stock.StockListFragment
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldjaimedicalplus.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldjaimedicalplus.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldjaimedicalplus.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldjaimedicalplus.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldjaimedicalplus.features.survey.SurveyFrag
import com.breezefieldjaimedicalplus.features.survey.SurveyViewDtlsFrag
import com.breezefieldjaimedicalplus.features.survey.SurveyViewFrag
import com.breezefieldjaimedicalplus.features.task.presentation.AddTaskFragment
import com.breezefieldjaimedicalplus.features.task.presentation.CalenderTaskFragment
import com.breezefieldjaimedicalplus.features.task.presentation.EditTaskFragment
import com.breezefieldjaimedicalplus.features.task.presentation.TaskListFragment
import com.breezefieldjaimedicalplus.features.taskManagement.TaskManagementFrag
import com.breezefieldjaimedicalplus.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldjaimedicalplus.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldjaimedicalplus.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldjaimedicalplus.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.CartFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.ViewCartFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldjaimedicalplus.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldjaimedicalplus.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldjaimedicalplus.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldjaimedicalplus.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldjaimedicalplus.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldjaimedicalplus.features.viewPPDDStock.ViewStockFragment
import com.breezefieldjaimedicalplus.features.weather.presentation.WeatherFragment
import com.breezefieldjaimedicalplus.mappackage.MapActivity
import com.breezefieldjaimedicalplus.mappackage.MapActivityWithoutPath
import com.breezefieldjaimedicalplus.mappackage.SendBrod
...
import com.breezefieldjaimedicalplus.features.NewQuotation.ViewAllQuotListFragment.Companion.shop_name
import com.breezefieldjaimedicalplus.features.addshop.model.AudioFetchDataCLass
import com.breezefieldjaimedicalplus.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldjaimedicalplus.features.login.model.NewSettingsResponseModel
import com.breezefieldjaimedicalplus.features.mylearning.AllTopicsWiseContents
import com.breezefieldjaimedicalplus.features.mylearning.BookmarkFetchResponse
import com.breezefieldjaimedicalplus.features.mylearning.BookmarkFrag
import com.breezefieldjaimedicalplus.features.mylearning.BookmarkPlayFrag
import com.breezefieldjaimedicalplus.features.mylearning.InCorrectQuesAnsFrag
import com.breezefieldjaimedicalplus.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldjaimedicalplus.features.mylearning.LeaderboardLmsFrag
import com.breezefieldjaimedicalplus.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldjaimedicalplus.features.mylearning.MyLearningAllVideoList
import com.breezefieldjaimedicalplus.features.mylearning.MyLearningTopicList
import com.breezefieldjaimedicalplus.features.mylearning.MyLearningVideoPlay
import com.breezefieldjaimedicalplus.features.mylearning.MyPerformanceFrag
import com.breezefieldjaimedicalplus.features.mylearning.MyTopicsWiseContents
import com.breezefieldjaimedicalplus.features.mylearning.MyTopicsWiseContents.Companion.topic_id
import com.breezefieldjaimedicalplus.features.mylearning.MyTopicsWiseContents.Companion.topic_name
import com.breezefieldjaimedicalplus.features.mylearning.NotificationLMSFragment
import com.breezefieldjaimedicalplus.features.mylearning.RetryIncorrectQuizFrag
import com.breezefieldjaimedicalplus.features.mylearning.RetryPlayFrag
import com.breezefieldjaimedicalplus.features.mylearning.RetryQuestionFrag
import com.breezefieldjaimedicalplus.features.mylearning.SearchLmsFrag
import com.breezefieldjaimedicalplus.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldjaimedicalplus.features.mylearning.SearchLmsLearningFrag
...
import com.breezefieldjaimedicalplus.features.performanceAPP.TargetVSAchvFrag
...
// Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        println("load_frag " + mFragType.toString() + " " + Pref.user_id.toString() + " "+ Pref.WillShowLoanDetailsInParty.toString() )
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldjaimedicalpluslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjaimedicalpluslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldjaimedicalplus/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldjaimedicalpluslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldjaimedicalpluslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldjaimedicalpluslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
